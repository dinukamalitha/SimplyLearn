...
import ForumSection from '../engagement/ForumSection';
            ...
            <div className="flex border-b border-white/10 mb-8">
                {tabs.map(tab => (
                    <button
                        ...
                        className={`px-6 py-3 font-medium text-sm transition-colors relative ${activeTab === tab.id ? 'text-blue-400' : 'text-gray-400 hover:text-white'
                            }`}
                    >
                        {tab.label}
                        {activeTab === tab.id && (
