        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <Link
                to="/dashboard"
                className="text-2xl font-bold text-transparent bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text"
              >
                SimplyLearn
              </Link>
              <div className="items-center hidden gap-2 md:flex">
                ...
                {(user?.role === "Student" ||
                  ...
                  <Link
                    to="/assignments"
                    className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 ${isActive("/assignments")}`}
                  >
            ...
            <div className="flex items-center gap-4">
              <Link to="/profile" className="flex items-center gap-3 group">
                ...
                <div className="flex items-center justify-center w-10 h-10 text-sm font-bold text-white rounded-full bg-gradient-to-tr from-blue-500 to-purple-600">
                  {user?.name?.charAt(0).toUpperCase()}
                </div>
              </Link>
              <button
                onClick={logout}
                className="p-2 text-gray-400 transition-colors rounded-lg hover:text-red-400 hover:bg-red-400/10"
                title="Logout"
              >
